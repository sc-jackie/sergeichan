...
Auxiliary roles (vision, web_extract, compression, title_generation, delegation subagents, …): `gpt-5.4-mini` (openai-codex), fallback `claude-haiku-4.5`.
