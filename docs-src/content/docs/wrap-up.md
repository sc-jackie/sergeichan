...
name: wrap-up
description: End-of-session handoff — roadmap reconcile, project-sync, ops-board kanban, vault Status, brief log, hot.md, commit + push.
---
...
## Compound check — gate, before vault sync
...
### A — Code shipped (`~/dev/*` merge or push to `main`)
