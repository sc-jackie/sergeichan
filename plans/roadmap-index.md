...
| -------- | ----- | --------- |
| [2026-07-13-001 cinematic six-act scroll redesign](2026-07-13-001-feat-cinematic-six-act-scroll-redesign-plan.md) | 🔵 **v1 shipped to prod** (2026-07-14, merge `7fcdb8f`) | Six WebGL acts live on the thread system; DOM-first content (truth-gated); editorial fallback; nav rail. Remaining: **EVE-88** polish (deep-links, work-act sizing, dive verify, origin composition, snap) + U9 owner content review. Gotchas: `docs/solutions/frontend/webgl-overnight-build-gotchas.md`. |
