...
### 2. Durable memory [#2-durable-memory]
...
### 3. Always-on loop [#3-always-on-loop]
...
### 4. Delegated work [#4-delegated-work]
...
### 5. Project tracking [#5-project-tracking]
...
## Rules that keep the system simple [#rules-that-keep-the-system-simple]
