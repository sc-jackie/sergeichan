...
| **Writes**       | Git commits (human + agent)                           | Vercel deploys                                        | Supabase deploys                                      | Vercel deploys; vault is read-only watcher     | Supabase Edge Fn + migrations; Cyrus/Codex auto-dispatch |
...
* **B-Unit linear workflow & autonomous agents:** B-Unit repo `docs/linear-workflow.md` (Cyrus/Codex dispatch)
