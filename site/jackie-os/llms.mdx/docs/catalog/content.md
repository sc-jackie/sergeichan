...
## Skills vs Scripts — decision [#skills-vs-scripts--decision]
...
## How it fits together (30-second orientation) [#how-it-fits-together-30-second-orientation]
...
## Skills — grouped by job [#skills--grouped-by-job]
...
## What runs when (cron) [#what-runs-when-cron]
