# hermes-ops (/docs/hermes-runbook)
...
**Two-bot model (current):*&#x2A; &#x2A;*[@Persik\_finbot](https://t.me/Persik_finbot)*&#x2A; = Newfin finance product + Sergei's owner finance/ops surface (Vercel-hosted). &#x2A;*[@persik\_hermes\_bot](https://t.me/persik_hermes_bot)** = the **full** Telegram channel for the Hermes VPS agent — COO, CTO, journal, crons, ops, everything. Both are live.
...
## Commands (natural language OK) [#commands-natural-language-ok]
...
## VPS crons (Phase 1 + 2 + explore) [#vps-crons-phase-1--2--explore]
...
## Web dashboard (Hermes Agent admin UI) [#web-dashboard-hermes-agent-admin-ui]
...
## Persik ops bridge (no inbound firewall) [#persik-ops-bridge-no-inbound-firewall]
...
## Model setup (subscriptions — no Nous Portal) [#model-setup-subscriptions--no-nous-portal]
