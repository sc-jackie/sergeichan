# Vault rhythm (/docs/vault-rhythm)
...
## Two schedulers on VPS (don't conflate) [#two-schedulers-on-vps-dont-conflate]
...
## Inventory — morning & vault automation [#inventory--morning--vault-automation]

### A · Pre-brief stack (07:00–07:15 Warsaw target) [#a--pre-brief-stack-07000715-warsaw-target]
...
### B · Morning brief (07:30 Warsaw target) [#b--morning-brief-0730-warsaw-target]
...
### C · Intraday vault [#c--intraday-vault]
...
### D · Session / on-demand (not scheduled) [#d--session--on-demand-not-scheduled]
...
### E · Period rhythm (week / month / year) [#e--period-rhythm-week--month--year]
...
## Mac vs VPS — parity matrix (2026-06-29) [#mac-vs-vps--parity-matrix-2026-06-29]
...
## Target architecture (consistent everywhere) [#target-architecture-consistent-everywhere]
...
## Parity roadmap (implementation order) [#parity-roadmap-implementation-order]
...
## Skill groups (navigation) [#skill-groups-navigation]
